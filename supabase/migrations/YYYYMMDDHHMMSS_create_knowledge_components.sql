...
COMMENT ON COLUMN public.knowledge_components.name IS 'Human-readable name of the KC.';
COMMENT ON COLUMN public.knowledge_components.grade_levels IS 'Array of applicable grade levels, e.g., [3, 4].';
COMMENT ON COLUMN public.knowledge_components.curriculum_standards IS 'Array of links to specific curriculum standards; JSONB structure: [{standardId: "...", standardSet: "...", description: "..."}].';
