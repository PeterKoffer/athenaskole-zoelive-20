...
export const usGeographyCurriculumData: CurriculumNode[] = [
  ...
  // --- Kindergarten: My World ---
  {
    ...
    educationalLevel: 'K', subject: NELIESubject.SOCIAL_STUDIES, tags: ['kindergarten', 'maps_basics', 'personal_location'],
  },
  {
    id: 'us-k-geo-spatial', parentId: 'us-k-geo', nodeType: 'domain', name: 'The World in Spatial Terms',
    educationalLevel: 'K', subject: NELIESubject.SOCIAL_STUDIES, tags: ['maps', 'globes', 'location'],
  },
  {
    ...
    educationalLevel: 'K', subject: NELIESubject.SOCIAL_STUDIES, tags: ['maps', 'globes', 'spatial_thinking'],
  },
  {
    ...
    educationalLevel: 'K', subject: NELIESubject.SOCIAL_STUDIES, tags: ['relative_location', 'classroom_geography'],
  },
  ...
  // --- Grade 1: My Community ---
  {
    ...
    educationalLevel: '1', subject: NELIESubject.SOCIAL_STUDIES, tags: ['grade1', 'community_geography', 'local_maps'],
  },
  {
    id: 'us-g1-geo-places', parentId: 'us-g1-geo', nodeType: 'domain', name: 'Places and Regions',
    educationalLevel: '1', subject: NELIESubject.SOCIAL_STUDIES, tags: ['community_features', 'local_places'],
  },
  {
    ...
    educationalLevel: '1', subject: NELIESubject.SOCIAL_STUDIES, tags: ['map_making', 'school_map', 'classroom_map'],
  },
  {
    ...
    educationalLevel: '1', subject: NELIESubject.SOCIAL_STUDIES, tags: ['physical_features', 'human_features', 'community_places'],
  },
  ...
  // --- Grade 2: Our World ---
  {
    ...
    educationalLevel: '2', subject: NELIESubject.SOCIAL_STUDIES, tags: ['grade2', 'world_geography', 'continents_oceans'],
  },
  {
    id: 'us-g2-geo-world', parentId: 'us-g2-geo', nodeType: 'domain', name: 'The World',
    educationalLevel: '2', subject: NELIESubject.SOCIAL_STUDIES, tags: ['continents', 'oceans', 'world_map'],
  },
  {
  ...
  },
  {
    ...
    educationalLevel: '2', subject: NELIESubject.SOCIAL_STUDIES, tags: ['community_types', 'urban', 'suburban', 'rural'],
  },
  ...
  // --- Grade 3: Our State & Region ---
  {
    ...
    educationalLevel: '3', subject: NELIESubject.SOCIAL_STUDIES, tags: ['grade3', 'state_geography', 'regional_landforms'],
  },
  {
    id: 'us-g3-geo-state', parentId: 'us-g3-geo', nodeType: 'domain', name: 'State & Regional Geography',
    educationalLevel: '3', subject: NELIESubject.SOCIAL_STUDIES, tags: ['state_maps', 'human_environment_interaction'],
  },
  {
    ...
    educationalLevel: '3', subject: NELIESubject.SOCIAL_STUDIES, tags: ['state_maps', 'physical_geography', 'human_geography'],
  },
  {
    ...
    educationalLevel: '3', subject: NELIESubject.SOCIAL_STUDIES, tags: ['human_environment_interaction', 'regional_adaptation'],
  },
  ...
  // --- Grade 4: U.S. Regions ---
  {
    ...
    educationalLevel: '4', subject: NELIESubject.SOCIAL_STUDIES, tags: ['grade4', 'us_regions', 'regional_geography'],
  },
  {
    id: 'us-g4-geo-regions', parentId: 'us-g4-geo', nodeType: 'domain', name: 'U.S. Regions',
    educationalLevel: '4', subject: NELIESubject.SOCIAL_STUDIES, tags: ['us_regions_map', 'regional_comparison'],
  },
  {
    ...
    educationalLevel: '4', subject: NELIESubject.SOCIAL_STUDIES, tags: ['us_regions_map', 'state_identification'],
  },
  {
    ...
    educationalLevel: '4', subject: NELIESubject.SOCIAL_STUDIES, tags: ['regional_comparison', 'physical_systems', 'natural_resources'],
  },
  ...
  // --- Grade 5: The United States in the World ---
  {
    ...
    educationalLevel: '5', subject: NELIESubject.SOCIAL_STUDIES, tags: ['grade5', 'western_hemisphere', 'us_geography_context'],
  },
  {
    id: 'us-g5-geo-hemisphere', parentId: 'us-g5-geo', nodeType: 'domain', name: 'The Western Hemisphere',
    educationalLevel: '5', subject: NELIESubject.SOCIAL_STUDIES, tags: ['map_skills', 'human_settlement'],
  },
  {
    ...
    educationalLevel: '5', subject: NELIESubject.SOCIAL_STUDIES, tags: ['latitude_longitude', 'coordinate_system', 'map_skills'],
  },
  {
    ...
    educationalLevel: '5', subject: NELIESubject.SOCIAL_STUDIES, tags: ['human_settlement', 'population_distribution', 'americas'],
  }
];
