...
const EnableNelieButton = ({ 
  ...
  return (
    <Button
      ...
      className="w-12 h-12 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 border-2 border-gray-600 hover:border-gray-500 flex items-center justify-center p-0"
    >
