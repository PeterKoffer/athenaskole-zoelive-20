  ...
  return (
    <div className="relative select-none">
      <div
        ...
        className="w-15 h-15 rounded-full cursor-grab active:cursor-grabbing transition-transform duration-200 hover:scale-105"
        style={{
      ...
      >
        <img 
          ...
          className="w-15 h-15 object-contain pointer-events-none"
          draggable={false}
          style={{ 
            userSelect: 'none',
            touchAction: 'none'
