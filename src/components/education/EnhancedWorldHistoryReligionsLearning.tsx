...
const EnhancedWorldHistoryReligionsLearning: React.FC = () => {
  ...
  if (isLoading) return <div className="flex justify-center items-center h-screen bg-gray-900/50"><div className="text-center p-10 bg-gray-800 rounded-lg shadow-xl"><LoadingSpinner size="lg" /><p className="mt-4 text-white">Loading History Lesson...</p></div></div>;
