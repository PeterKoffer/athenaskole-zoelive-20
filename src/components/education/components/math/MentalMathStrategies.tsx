  ...
  return (
    <Blackboard>
      ...
      <div className="text-gray-300 space-y-6">
        ...
        <TextWithSpeaker
          text="Key mental math strategies include number bonds, compensation, doubling and halving, and using benchmark numbers"
          context="mental-math-strategies-overview"
          position="corner"
          showOnHover={false}
        >
          <div className="bg-blue-900/30 rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <TextWithSpeaker
                  text="Number bonds help you break numbers into friendly parts that add up to 10. For example, 8 plus 7 equals 8 plus 2 plus 5, which equals 10 plus 5, which equals 15"
                  context="number-bonds-strategy"
                  position="corner"
                  showOnHover={false}
                >
                ...
                <TextWithSpeaker
                  text="Compensation means rounding to easier numbers, then adjusting your answer. For example, 29 plus 15 becomes 30 plus 15 minus 1, which equals 44"
              ...
              <div className="space-y-3">
                <TextWithSpeaker
                  text="Doubling and halving uses known doubles to solve problems. For example, 6 times 8 equals 6 times 4 times 2, which equals 24 times 2, which equals 48"
                  context="doubling-halving-strategy"
                  position="corner"
                  showOnHover={false}
                >
                ...
                <TextWithSpeaker
                  text="Benchmark numbers like 10, 100, or 1000 serve as reference points. For example, 98 plus 47 becomes 100 plus 47 minus 2, which equals 145"
                  context="benchmark-numbers-strategy"
                  position="corner"
                  showOnHover={false}
                >
        ...
        <TextWithSpeaker
          text="Here are quick tips for mental math success: Practice with small numbers first, then work up to larger ones. Look for patterns and number relationships. Use the strategy that feels most comfortable for each problem. Don't rush, accuracy is more important than speed"
