...
const EnglishLessonHeader = ({
  ...
  return (
    <div className="w-full flex justify-center py-4">
      <div className="bg-black/60 rounded-xl border border-cyan-400/30 backdrop-blur-md p-4 max-w-2xl">
        ...
        <div className="text-center mt-3">
          <h1 className="text-sm font-semibold text-white bg-black/30 rounded px-3 py-1 inline-block border border-cyan-400/20">
