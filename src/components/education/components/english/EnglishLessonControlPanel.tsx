...
interface EnglishLessonControlPanelProps {
  isSpeaking: boolean;
  onToggleMute: () => void;
  onReadRequest: () => void;
  onStopSpeaking: () => void;
...
const EnglishLessonControlPanel = ({
  isSpeaking,
  onToggleMute,
  onReadRequest,
  onStopSpeaking
}: EnglishLessonControlPanelProps) => {
  return (
      ...
      <div className="w-full max-w-4xl mx-auto px-4 py-4">
        <div className="flex justify-center space-x-4">
          <Button
            ...
            className="border-cyan-400 text-cyan-200 bg-gray-700/50 backdrop-blur-sm hover:bg-gray-600/60"
          >
...
export default EnglishLessonControlPanel;
