...
const LessonComplete = ({
  ...
  return <Card className="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 border-purple-400">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <Button onClick={onRetry} className="w-full bg-lime-400 hover:bg-lime-500 text-black font-semibold">
            <RotateCcw className="w-4 h-4 mr-2" />
            Try Again
          </Button>
          <Button onClick={onBack} variant="outline" className="w-full border-gray-600 text-slate-950 bg-slate-50">
