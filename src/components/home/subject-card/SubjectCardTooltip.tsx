...
const SubjectCardTooltip: React.FC<SubjectCardTooltipProps> = ({ subject, isVisible }) => {
  ...
  return (
    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-80 bg-gray-900/95 backdrop-blur-md shadow-xl rounded-2xl p-4 z-30 border border-gray-700 animate-fade-in">
