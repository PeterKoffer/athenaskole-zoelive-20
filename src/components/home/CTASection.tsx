        ...
        <TextWithSpeaker text="Ready to Transform Your Learning Experience? Join thousands of students who have already discovered the power of AI-enhanced education with Nelie." context="cta-section" position="corner" showOnHover={false}>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
            ...
            <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
              ...
              <Button onClick={() => navigate("/daily-program")} variant="outline" size="lg" className="w-full sm:w-auto border-2 border-white hover:text-blue-600 font-semibold py-3 px-8 rounded-lg transition-all duration-300 text-white bg-neutral-50">
                View Daily Program
              </Button>
            </div>
          </div>
