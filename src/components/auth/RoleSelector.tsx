      ...
      <Card className="w-full max-w-4xl bg-gray-800 border-gray-700">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            return <Button key={role} variant="outline" className="h-auto p-6 bg-gray-700 border-gray-600 hover:bg-gray-600 text-white flex flex-col space-y-3" onClick={() => onRoleSelect(role as UserRole)}>
          ...
          <div className="text-center mt-6">
            <Button variant="outline" onClick={onBack} className="border-gray-600 text-zinc-950 bg-slate-50">
              Back to home page
            </Button>
          </div>
        </CardContent>
