                           ...
                           className={`
                             ...
                             ${hasAnswered 
                               ? index === activity.content?.correctAnswer
                                 ? 'bg-gradient-to-r from-green-600 to-emerald-600 border-green-400 text-white shadow-green-400/20 shadow-lg'
                                 : selectedAnswer === index
                                   ? 'bg-gradient-to-r from-red-600 to-pink-600 border-red-400 text-white shadow-red-400/20 shadow-lg'
                                   : 'bg-gray-700 border-gray-600 text-gray-300'
                               : 'bg-slate-800 hover:bg-slate-700 border-slate-600 text-white hover:border-purple-400'
                             }
                           `}
                         >
                           <span className="flex items-center gap-3 w-full">
                             <span className="w-8 h-8 rounded-full border-2 border-white/50 flex items-center justify-center text-sm font-bold bg-white/10 text-white">
